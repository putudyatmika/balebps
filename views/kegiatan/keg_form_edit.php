...
if ($_SESSION['sesi_level'] > 2) {
    if ($_SESSION['sesi_level'] > 3) {
        ...
        if (($_SESSION['sesi_unitkerja']==$r_keg["item"][1]["keg_unitkerja"]) or ($_SESSION['sesi_unitkerja']==$r_keg["item"][1]["keg_unitparent"])) {
            ...
            $edit_keg=false;
            $error_msg='ERROR : hak akses level tidak bisa';
        }
    }
}
else {
...
<div class="row wrapper wrapper-content animated fadeInRightBig tooltip-bps">
     <div class="row">
        <div class="col-lg-7">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                       <?php if (($r_keg["error"]==false) and ($edit_keg==true)) { ?>
                            ...
                            <div class="form-group">
                                <label for="keg_tglmulai" class="col-sm-2 control-label">Tgl Mulai</label>
                                    <div class="col-sm-5" id="tanggal_data">
                                        <div class="input-group margin-bottom-sm">
                                    <span class="input-group-addon"><i class="fa fa-tag fa-fw"></i></span>
                                    <input type="text" name="keg_tglmulai" id="keg_tglmulai" class="form-control" autocomplete="off" placeholder="Format : YYYY-MM-DD" value="<?php echo $r_keg["item"][1]["keg_start"];?>" />
                                    </div>
                                    </div>
                            </div>
                            <div class="form-group">
                                <label for="keg_tglmulai" class="col-sm-2 control-label">Tgl Berakhir</label>
                                    <div class="col-sm-5" id="tanggal_data">
                                        <div class="input-group margin-bottom-sm">
                                    <span class="input-group-addon"><i class="fa fa-tag fa-fw"></i></span>
                                    <input type="text" name="keg_tglakhir" id="keg_tglakhir" class="form-control" autocomplete="off" placeholder="Format : YYYY-MM-DD" value="<?php echo $r_keg["item"][1]["keg_end"];?>" />
                                    </div>
                                    </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="keg_target_spj" class="col-sm-2 control-label">Total Target SPJ</label>
                                    <div class="col-sm-6">
                                        <div class="input-group margin-bottom-sm">
                                    <span class="input-group-addon"><i class="fa fa-tag fa-fw"></i></span>
                                    <input type="text" name="keg_target_spj" id="keg_target_spj" class="form-control spj_target_total" placeholder="Total Target SPJ bila ada SPJ" value="<?php echo $r_keg["item"][1]["keg_spj_target"];?>" />
                                    </div>
                                    </div>
                            </div>
                            <div class="form-group">
                                <label for="keg_tipe" class="col-sm-2 control-label">Tipe Kegiatan</label>
                                    <div class="col-sm-6">
                                        <div class="input-group margin-bottom-sm">
                                        <span class="input-group-addon"><i class="fa fa-tag fa-fw"></i></span>
                                        <input type="text" name="keg_target" id="keg_target" class="form-control target_total" placeholder="Total Target" value="<?php echo $KegiatanTipe[$r_keg["item"][1]["keg_tipe"]];?>" disabled/>
                                        </div>
                                    </div>
                            </div>
                                        <?php }
        ...
        <?php 
        //bila terjadi error
        if (($r_keg["error"]==false) and ($edit_keg==true)) { ?>                                
        <div class="col-lg-5">
                <?php if ($r_keg["item"][1]["keg_tipe"]==2) { ?> 
                <div class="ibox float-e-margins" id="listTargetKabkota">
                    ...
                    <div class="ibox-content">
                       ...
                       <table class="table table-striped table-hover" >
                            ...
                            <tbody>
                            <?php
                                 $r_target=list_target_keg_spj_kabkota($keg_id,$r_keg["item"][1]["keg_tipe"]);
                ...
                <div class="ibox float-e-margins" id="listTargetBidang">
