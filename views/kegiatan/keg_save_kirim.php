<div class="row wrapper border-bottom white-bg page-heading">
	...
	<li class="active">
		<strong>Simpan konfirmasi pengiriman</strong>
	</li>
        ...
        <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Simpan konfirmasi pengiriman</h5>
                    ...
                    <div class="ibox-content">
                        ...
                        if ($_POST['submit_keg']) {
                            ...
                            if ($keg_d_tgl=='' or $keg_d_jumlah=='') {
                                ...
                                $r_save_kirim=save_konfirmasi_pengiriman($keg_id,$keg_d_unitkerja,$keg_d_tgl,$keg_d_jumlah,$keg_d_ket,$keg_d_link);
