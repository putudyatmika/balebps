                    ...
                    <?php
                        ...
                        if ($r_peg["error"]==false) { 
                            ...
                            <div class="alert alert-warning" role="alert">
                                    ...
                                    <?php
                                    echo '
                                    <a href="'.$url.'/'.$page.'/pegawai/edit/'.$peg_no.'" class="btn btn-success"><i class="fa fa-pencil fa-lg"></i></a>
                                    <a href="'.$url.'/'.$page.'/pegawai/delete/'.$peg_no.'" class="btn btn-danger" data-confirm="Apakah data ('.$r_peg["item"][1]["peg_id"].') '.$r_peg["item"][1]["peg_nama"].' ini akan di hapus?"><i class="fa fa-trash fa-lg"></i></a>';
                                    ?>
                                    </div>
                                    </div>
                            </div>
